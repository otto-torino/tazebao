/** 
 * Mosaico - OpenSource Email Template Editor - v0.17.5 - 2019-06-11 
...
(function (global){
"use strict";var console=require("console-browserify"),ko="undefined"!=typeof window?window.ko:"undefined"!=typeof global?global.ko:null,$="undefined"!=typeof window?window.jQuery:"undefined"!=typeof global?global.jQuery:null,lsLoader=function(e,a){var t=global.localStorage.getItem("metadata-"+e);if(null!==t){var o,l=global.localStorage.getItem("template-"+e);null!==l&&(o=JSON.parse(l));var n=JSON.parse(t);return{metadata:n,model:o,extension:lsCommandPluginFactory(n,a)}}throw"Cannot find stored data for "+e},lsCommandPluginFactory=function(e,a){return function(e,t,o){var l={name:"Save",enabled:ko.observable(!0),execute:function(){l.enabled(!1),o.metadata.changed=Date.now(),void 0===o.metadata.key&&(console.warn("Unable to find key in metadata object...",o.metadata),o.metadata.key=e),global.localStorage.setItem("metadata-"+e,o.exportMetadata()),global.localStorage.setItem("template-"+e,o.exportJSON()),l.enabled(!0)}},n={name:"Save To Server",enabled:ko.observable(!0),execute:function(){n.enabled(!1),o.metadata.changed=Date.now(),void 0===o.metadata.key&&(console.warn("Unable to find key in metadata object...",o.metadata),o.metadata.key=e),$.ajax({url:"/mosaico/template/",type:"POST",data:{key:o.metadata.key,name:o.metadata.key,meta_data:o.exportMetadata(),template_data:o.exportJSON(),html:o.exportHTML(),action:"save"},success:function(e){o.notifier.success(o.t("Successfully saved."))},error:function(e,a,t){o.notifier.error(o.t("Saving failed."))}}).always(function(){n.enabled(!0)})}},r={name:"Test",enabled:ko.observable(!0)},d={name:"Download",enabled:ko.observable(!0)};r.execute=function(){r.enabled(!1);var l=global.localStorage.getItem("testemail");if(null!==l&&"null"!=l||(l=o.t("Insert here the recipient email address")),"function"!=typeof global.prompt)global.alert(o.t("This feature is not supported by your browser")),r.enabled(!0);else if(null!=(l=global.prompt(o.t("Test email address"),l))&&l.match(/@/)){global.localStorage.setItem("testemail",l);var n=a||"/dl/",d=$.post(n,{action:"email",rcpt:l,subject:"[test] "+e+" - "+t,html:o.exportHTML()},null,"html");d.fail(function(){console.log("fail",arguments),o.notifier.error(o.t("Unexpected error talking to server: contact us!"))}),d.success(function(){console.log("success",arguments),o.notifier.success(o.t("Test email sent..."))}),d.always(function(){r.enabled(!0)})}else global.alert(o.t("Invalid email address")),r.enabled(!0)},d.execute=function(){d.enabled(!1),o.notifier.info(o.t("Downloading...")),o.exportHTMLtoTextarea("#downloadHtmlTextarea");var e=a||"/dl/";global.document.getElementById("downloadForm").setAttribute("action",e),global.document.getElementById("downloadForm").submit(),d.enabled(!0)},o.save=l,o.saveToServer=n,o.test=r,o.download=d}.bind(void 0,e.key,e.name)};module.exports=lsLoader;
